...
<template>
  ...
  <el-dialog v-model="downloadDialogVisible" title="下载" width="30%">
    ...
    <template #footer>
      <span>
        <el-button size="medium" @click="downloadDialogVisible = false">Github</el-button>
        <el-button size="medium" @click="downloadDialogVisible = false" type="primary">Gitee</el-button>
      </span>
    </template>
  </el-dialog>
</template>
